...
export const Nav = ({className}: React.ComponentPropsWithRef<'nav'>) => <nav className={twMerge('navbar rounded-b-lg bg-base-100 shadow-lg', className)}>
  <div className="flex-1 gap-1">
    <Link className="btn glass" to="/"> <img alt='rick and morty image' src={'/R&M.svg'} className="w-6 text-sm" />  <span>Rick and Morty <b>API</b></span></Link>
  </div>
  <div className="flex-none">
    ...
    >
      <Icon name="setting" className="w-6" />
    </button>
  </div>
</nav>
